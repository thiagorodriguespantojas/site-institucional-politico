  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-6">
      <div className="max-w-sm w-full bg-white shadow p-6 rounded">
        ...
        <input className="border p-2 mb-2 w-full" placeholder="Usuário" onChange={e => setUser(e.target.value)} />
        <input className="border p-2 mb-2 w-full" placeholder="Senha" type="password" onChange={e => setPass(e.target.value)} />
